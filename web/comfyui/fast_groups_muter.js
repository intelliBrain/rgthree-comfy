...
export class BaseFastGroupsModeChanger extends RgthreeBaseVirtualNode {
  ...
  refreshWidgets() {
    ...
    let sort =
      ((_a = this.properties) === null || _a === void 0 ? void 0 : _a[PROPERTY_SORT]) || "position";
    ...
    if (sort === "custom alphabet") {
      ...
      if (
        !(customAlphabet === null || customAlphabet === void 0 ? void 0 : customAlphabet.length)
      ) {
        sort = "alphanumeric";
        customAlphabet = null;
      }
    ...
    let filterColors = (
      ((_e =
        (_d = this.properties) === null || _d === void 0 ? void 0 : _d[PROPERTY_MATCH_COLORS]) ===
        null || _e === void 0
        ? void 0
        : _e.split(",")) || []
    ).filter((c) => c.trim());
    ...
    for (const group of groups) {
      ...
      if (
        (_h =
          (_g = this.properties) === null || _g === void 0 ? void 0 : _g[PROPERTY_MATCH_TITLE]) ===
          null || _h === void 0
          ? void 0
          : _h.trim()
      ) {
          ...
          mouse(event, pos, node) {
            ...
            if (event.type == "pointerdown") {
              if (
                ...
                const canvas = app.canvas;
                const lowQuality =
                  (((_b = canvas.ds) === null || _b === void 0 ? void 0 : _b.scale) || 1) <= 0.5;
                if (!lowQuality) {
                  canvas.centerOnNode(group);
                  const zoomCurrent =
                    ((_c = canvas.ds) === null || _c === void 0 ? void 0 : _c.scale) || 1;
  ...
  async handleAction(action) {
    ...
    if (action === "Mute all" || action === "Bypass all") {
      const alwaysOne =
        ((_a = this.properties) === null || _a === void 0 ? void 0 : _a[PROPERTY_RESTRICTION]) ===
        "always one";
      ...
      if (
        !foundOne &&
        ((_d = this.properties) === null || _d === void 0 ? void 0 : _d[PROPERTY_RESTRICTION]) ===
          "always one"
      ) {
