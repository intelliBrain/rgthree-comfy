...
export class Label extends RgthreeBaseVirtualNode {
  ...
  onShowCustomPanelInfo(panel) {
    var _a, _b;
    (_a = panel.querySelector('div.property[data-property="Mode"]')) === null || _a === void 0
      ? void 0
      : _a.remove();
    (_b = panel.querySelector('div.property[data-property="Color"]')) === null || _b === void 0
      ? void 0
      : _b.remove();
  }
  inResizeCorner(x, y) {
  ...
  if (
    ...
    if (!isDoubleClick) {
      nodes_list = [...nodes_list].filter((n) => {
        var _a;
        return (
          !(n instanceof Label) || !((_a = n.flags) === null || _a === void 0 ? void 0 : _a.pinned)
        );
      });
    }
  }
