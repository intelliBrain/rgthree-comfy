...
export class RgthreeImageComparer extends RgthreeBaseServerNode {
  ...
  onSerialize(o) {
    ...
    for (let [index, widget_value] of (o.widgets_values || []).entries()) {
      if (
        ((_a = this.widgets[index]) === null || _a === void 0 ? void 0 : _a.name) ===
        "rgthree_comparer"
      ) {
...
class RgthreeImageComparerWidget extends RgthreeBaseWidget {
  ...
  draw(ctx, node, width, y) {
    ...
    if (
      ((_a = node.properties) === null || _a === void 0 ? void 0 : _a["comparer_mode"]) === "Click"
    ) {
  ...
  drawImage(ctx, image, y, cropX) {
    var _a, _b;
    if (
      !((_a = image === null || image === void 0 ? void 0 : image.img) === null || _a === void 0
        ? void 0
        : _a.naturalWidth) ||
      !((_b = image === null || image === void 0 ? void 0 : image.img) === null || _b === void 0
        ? void 0
        : _b.naturalHeight)
    ) {
      return;
    ...
    const widthMultiplier =
      (image === null || image === void 0 ? void 0 : image.img.naturalWidth) / targetWidth;
    const sourceX = 0;
    const sourceY = 0;
    const sourceWidth =
      cropX != null
