...
class Rgthree extends EventTarget {
  constructor() {
    ...
    const logLevel =
      (_d = LogLevelKeyToLogLevel[CONFIG_SERVICE.getConfigValue("log_level")]) !== null &&
      _d !== void 0
        ? _d
        : GLOBAL_LOG_LEVEL;
    ...
    CONFIG_SERVICE.addEventListener("config-change", (e) => {
      var _a, _b;
      if (
        (_b = (_a = e.detail) === null || _a === void 0 ? void 0 : _a.key) === null || _b === void 0
          ? void 0
    ...
    if (CONFIG_SERVICE.getConfigValue("features.progress_bar.enabled")) {
      ...
      if (!this.progressBarEl) {
        ...
        this.progressBarEl.addEventListener("pointerdown", async (e) => {
          ...
          if (e.button == 0) {
            const nodeId =
              (_a = this.progressBarEl) === null || _a === void 0 ? void 0 : _a.currentNodeId;
            if (nodeId) {
  ...
  initializeComfyUIHooks() {
    ...
    api.queuePrompt = async function (index, prompt) {
      var _a;
      if (
        ((_a = rgthree.queueNodeIds) === null || _a === void 0 ? void 0 : _a.length) &&
        prompt.output
      ) {
    ...
    app.loadGraphData = function (graph) {
      ...
      setTimeout(() => {
        ...
        const wasLoadingAborted =
          (_b =
            (_a = document.querySelector(".comfy-modal-content")) === null || _a === void 0
              ? void 0
  ...
  getNodeFromInitialGraphToPromptSerializedWorkflowBecauseComfyUIBrokeStuff(node) {
    ...
    return (_c =
      (_b =
        (_a = this.initialGraphToPromptSerializedWorkflowBecauseComfyUIBrokeStuff) === null ||
        _a === void 0
          ? void 0
