...
const CONFIG_REROUTE =
  ((_a = rgthreeConfig === null || rgthreeConfig === void 0 ? void 0 : rgthreeConfig["nodes"]) ===
    null || _a === void 0
    ? void 0
    : _a["reroute"]) || {};
...
class RerouteService {
  constructor() {
    ...
    if (
      ...
      (CONFIG_KEY_CREATE_WHILE_LINKING === null || CONFIG_KEY_CREATE_WHILE_LINKING === void 0
        ? void 0
    ...
    Object.defineProperty(canvas, canvasProperty, {
      ...
      set: function (value) {
        ...
        const isPropNull =
          ...
          !((_a = this[`_${canvasProperty}`]) === null || _a === void 0 ? void 0 : _a.length);
  ...
  insertNewRerouteWhileLinking() {
    ...
    let connectingDir =
      (_a = data.input || data.output) === null || _a === void 0 ? void 0 : _a.dir;
    if (!connectingDir) {
...
class RerouteNode extends RgthreeBaseVirtualNode {
  ...
  onConstructed() {
    var _a;
    this.setResizable(
      (_a = this.properties["resizable"]) !== null && _a !== void 0 ? _a : configResizable,
    );
  ...
  configure(info) {
    ...
    this.setResizable(
      (_c = this.properties["resizable"]) !== null && _c !== void 0 ? _c : configResizable,
    );
    this.applyNodeSize();
  ...
  onDrawForeground(ctx, canvas) {
    ...
    if ((_a = this.properties) === null || _a === void 0 ? void 0 : _a["showLabel"]) {
      const low_quality =
        ((_b = canvas === null || canvas === void 0 ? void 0 : canvas.ds) === null || _b === void 0
          ? void 0
      ...
      ctx.fillText(
        String(
          this.title && this.title !== RerouteNode.title
            ? this.title
            : ((_d = (_c = this.outputs) === null || _c === void 0 ? void 0 : _c[0]) === null ||
              _d === void 0
                ? void 0
                : _d.type) || "",
        ),
  ...
  stabilize() {
    ...
    while (currentNode) {
      ...
      if (linkId !== null) {
        ...
        if (type === null || type === void 0 ? void 0 : type.includes("Reroute")) {
          ...
          inputType =
            (_b = input === null || input === void 0 ? void 0 : input.type) !== null &&
            _b !== void 0
              ? _b
              : null;
          break;
      ...
      if (outputs.length) {
        for (const linkId of outputs) {
          ...
          if (type === null || type === void 0 ? void 0 : type.includes("Reroute")) {
            ...
            const output =
              (_d =
                (_c = node.inputs) === null || _c === void 0 ? void 0 : _c[link.target_slot]) !==
                null && _d !== void 0
                ? _d
                : null;
      ...
      try {
        if (outputWidgetConfig && outputWidget && outputType) {
          ...
          setWidgetConfig(
            node.inputs[0],
            [
              outputType !== null && outputType !== void 0 ? outputType : displayType,
              outputWidgetConfig,
            ],
            outputWidget,
          );
    ...
    (_k =
      inputNode === null || inputNode === void 0 ? void 0 : inputNode.onConnectionsChainChange) ===
      null || _k === void 0
      ? void 0
      : _k.call(inputNode);
    (_l =
...
addMenuItem(RerouteNode, app, {
  ...
  callback: (node_, value) => {
    ...
    if (value === null || value === void 0 ? void 0 : value.startsWith("Rotate 90° Clockwise")) {
      ...
      value === null || value === void 0 ? void 0 : value.startsWith("Rotate 90° Counter-Clockwise")
    ) {
      node.rotate(-90);
      ...
      if (value === null || value === void 0 ? void 0 : value.startsWith("Flip Horizontally")) {
        ...
        value === null || value === void 0 ? void 0 : value.startsWith("Flip Vertically")
      ) {
