...
class RgthreePowerLoraLoader extends RgthreeBaseServerNode {
  ...
  configure(info) {
    var _b;
    while ((_b = this.widgets) === null || _b === void 0 ? void 0 : _b.length) this.removeWidget(0);
    this.widgetButtonSpacer = null;
    ...
    for (const widgetValue of info.widgets_values || []) {
      if (
        (widgetValue === null || widgetValue === void 0 ? void 0 : widgetValue.lora) !== undefined
      ) {
  ...
  getSlotInPosition(canvasX, canvasY) {
    ...
    if (!slot) {
      ...
      if (
        (_b = lastWidget === null || lastWidget === void 0 ? void 0 : lastWidget.name) === null ||
        _b === void 0
          ? void 0
          : _b.startsWith("lora_")
      ) {
  ...
  getSlotMenuOptions(slot) {
    ...
    if (
      (_c =
        (_b = slot === null || slot === void 0 ? void 0 : slot.widget) === null || _b === void 0
          ? void 0
      ...
      const canMoveUp = !!((_e =
        (_d = this.widgets[index - 1]) === null || _d === void 0 ? void 0 : _d.name) === null ||
      _e === void 0
        ? void 0
        : _e.startsWith("lora_"));
      const canMoveDown = !!((_g =
        (_f = this.widgets[index + 1]) === null || _f === void 0 ? void 0 : _f.name) === null ||
      _g === void 0
        ? void 0
        : _g.startsWith("lora_"));
      const menuItems = [
  ...
  hasLoraWidgets() {
    ...
    return !!((_b = this.widgets) === null || _b === void 0
      ...
      : _b.find((w) => {
          var _b;
          return (_b = w.name) === null || _b === void 0 ? void 0 : _b.startsWith("lora_");
        }));
  }
  allLorasState() {
    var _b, _c, _d;
    ...
    return allOn && ((_d = this.widgets) === null || _d === void 0 ? void 0 : _d.length)
      ? true
      : false;
  }
  toggleAllLoras() {
...
class PowerLoraLoaderWidget extends RgthreeBaseWidget {
  ...
  draw(ctx, node, w, posY, height) {
    ...
    if (
      ((_e = this.loraInfo) === null || _e === void 0 ? void 0 : _e.strengthMax) != null &&
      strengthValue > ((_f = this.loraInfo) === null || _f === void 0 ? void 0 : _f.strengthMax)
    ) {
      textColor = "#c66";
    } else if (
      ((_g = this.loraInfo) === null || _g === void 0 ? void 0 : _g.strengthMin) != null &&
      strengthValue < ((_h = this.loraInfo) === null || _h === void 0 ? void 0 : _h.strengthMin)
    ) {
      textColor = "#c66";
    }
    ...
    if (this.showModelAndClip) {
      ...
      let textColor = undefined;
      if (
        ((_j = this.loraInfo) === null || _j === void 0 ? void 0 : _j.strengthMax) != null &&
        this.value.strength >
          ((_k = this.loraInfo) === null || _k === void 0 ? void 0 : _k.strengthMax)
      ) {
        textColor = "#c66";
      } else if (
        ((_l = this.loraInfo) === null || _l === void 0 ? void 0 : _l.strengthMin) != null &&
        this.value.strength <
          ((_m = this.loraInfo) === null || _m === void 0 ? void 0 : _m.strengthMin)
      ) {
        textColor = "#c66";
      }
      const [leftArrow, text, rightArrow] = drawNumberWidgetPart(ctx, {
  ...
  doOnStrengthAnyMove(event, isTwo = false) {
    ...
    if (event.deltaX) {
      ...
      this.value[prop] =
        ((_b = this.value[prop]) !== null && _b !== void 0 ? _b : 1) + event.deltaX * 0.05;
    }
  }
